            ...
            <div className="col-md-12">
                ...
                <div className="accordion" id="accordionExample">                
                  ...
                  <div  className="accordion-item">
                    <h2 className="accordion-header" id="heading2">   
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                        My KYC status is rejected.
                      </button>
                    </h2>
                    <div id="collapse2" className="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        Rejected: Your KYC might be rejected due to one of the following reasons:
                        <ul>
                          <li>
                            Unclear or incorrect document image

                          </li>
                          <li>
                            Invalid KYC (Under 18, restricted state, NRI or international)

                          </li>
                          <li>
                            Mismatch in KYC and Bank details
                  ...
                  <div className="accordion-item">
                    ...
                    <div id="collapse3" className="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <ul>
                          <li>
                            Login to <a href="www.pokerbaazi.com" target="_blank">www.pokerbaazi.com</a> or log in from a
                            desktop or mobile app.
                          </li>
                          <li>Click on "My account" in the desktop app or click on "My profile" on the mobile app.</li>
                          <li>On the desktop app, click on KYC and select the bank account option. Click on "change bank
                            details" to update new bank details.</li>
                          <li>On the mobile app, click on "change bank details" to update new bank details.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    ...
                    <div id="collapse4" className="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <ul>
                          <li>Log in to <a href="www.pokerbaazi.com" target="_blank">www.pokerbaazi.com</a> or log in from
                            the desktop or mobile app.</li>
                          <li>Click on "My account" in the desktop client or click on "My profile" on the mobile app.</li>
                          <li>On the desktop app, click on "verify account" and then click on the "edit" button next to
                            your existing phone number. Enter the new phone number and verify it via OTP to update the new
                            number.</li>
                          <li>On the mobile app, click on the "edit" button mentioned next to your existing phone number.
                            Enter the new phone number and verify it via OTP to update the new number.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading5">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                        Why am I not able to deposit?
                      </button>
                    </h2>
                    <div id="collapse5" className="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        You may not be able to deposit due to one of the following reasons:
                        <ul>
                          <li>Information is incomplete or incorrect
                          </li>
                          <li>
                            Not following the rules for deposit (Allowed amount, less than minimum deposit)

                          </li>
                          <li>
                            Using an expired deposit code or not meeting minimum deposit requirements.
                          ...
                          <li>
                            Using either one of the following payment methods - American Express, HDFC Diner Card, HDFC
                            Net Banking/

                          </li>
                          <li>
                            Issues with internet connectivity [please clear cache and cookies from your browser / app
                            settings]

                          </li>
                        </ul>
                        <strong>NOTE:</strong> If the issue persists and we request you to share the screenshot/video
                        with <a>playerrelations@pokerbaazi.com</a>. We will immediately get it checked with the
                        technical team.
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading6">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                        What if money is deducted from my bank account <br /> but  not reflected in my PokerBaazi account?
                    ...
                    <div id="collapse6" className="accordion-collapse collapse" aria-labelledby="heading6" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>
                          Please check the video below to see why your transaction might not have gone through.

                        </p>
                        <p>
                          Stuck Transaction: Sometimes due to weak internet or some other similar issue, the transaction
                          doesn’t reach us and gets stuck at your bank or the payment gateway. If the transaction is stuck
                          at the payment gateway and once the transaction gets highlighted during the internal audits then
                          we manually credit the same into your PokerBaazi account.
                          <br />
                          You may also contact us over chat or send an email to <a>playerrelations@pokerbaazi.com</a> and
                          share the transaction number/date time and amount and we will manually check and credit it.

                        </p>

                        <p>
                          <strong>Failed Transaction:</strong>
                          In case the transaction fails at the gateway, it gets refunded to you by your bank. It usually
                          takes 7-10 days for the refund.
                        </p>
                        <p>
                          <strong>Pending Transaction:</strong>
                          At times, the transaction remains pending at the gateway. However, you don’t need to worry in
                          this case. The correct status gets updated in 24 hours.
                  ...
                  <div className="accordion-item">
                    ...
                    <div id="collapse7" className="accordion-collapse collapse" aria-labelledby="heading7" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>
                          You might not be able to withdraw due to one of the following reasons:

                        </p>
                        <ul>
                          <li>
                            Incomplete or incorrect information. (Pending KYC, Incorrect Bank Details)

                          </li>
                          <li>
                            Not following the rules for withdrawal (Withdrawal Balance, Locked Balance, Withdrawing Less
                            Than INR 100)

                          </li>
                          <li>
                            Not completing the coin criteria set by using a deposit code.

                          </li>
                          <li>
                            Entering the wrong OTP while making a withdrawal request.
                        ...
                        <p>
                          <strong>Note:</strong> If the still issue persists, we request you to share the screenshot/video
                          with <a>playerrelations@pokerbaazi.com</a>. We will immediately get it checked with our
                          technical team.
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading8">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
                        I have requested a withdrawal but I didn’t receive <br />  it in my bank account instantly. Why?
                    ...
                    <div id="collapse8" className="accordion-collapse collapse" aria-labelledby="heading8" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>
                          The Instant Withdrawals feature is available to those players who have completed their KYC and
                          it has been approved. The Instant Withdrawals feature might not be available in the following
                          cases:
                        ...
                        <ul>
                          ...
                          <li>
                            Per day Transaction Limit is 30K

                          </li>
                          <li>
                            If a fee is being charged on any withdrawal, it will be processed the next day.
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading9">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse9" aria-expanded="false" aria-controls="collapse9">
                        My withdrawal should have been processed as <br /> per the withdrawal
                        policy, however, I have not <br /> received the money and the status is showing <br /> pending. What should I
                        do?
                      </button>
                    </h2>
                    <div id="collapse9" className="accordion-collapse collapse" aria-labelledby="heading9" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>
                          Due to our internal verification process, some requests may be delayed by 72 hours. If there is
                          any further delay, we will reach out to you on your registered email ID.
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading10">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                        When will I get the leaderboard winnings?
                      </button>
                    </h2>
                    <div id="collapse10" className="accordion-collapse collapse" aria-labelledby="heading10" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>
                          Tournament Leaderboard winnings get credited the next working day once the tournament series
                          gets over in the form of RCB in your PokerBaazi account.

                        </p>
                        <p>
                          If there is a daily/weekly/monthly/yearly leaderboard running then the same will be credited by
                          the next working day in the form of RCB in your PokerBaazi account.

                        </p>
                        <p>
                          Cash games leaderboard winnings get credited to your PokerBaazi account the next working day
                          after the cash game promotion for the leaderboard ends.
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading11">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse11" aria-expanded="false" aria-controls="collapse11">
                        I had requested to deactivate my PokerBaazi <br />
                        account by mistake. How can I reactivate it?
                      </button>
                    </h2>
                    <div id="collapse11" className="accordion-collapse collapse" aria-labelledby="heading11" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <ul>
                          <li>
                            In case you have opted in for a Poker Break for a specific period of time, your account will
                            be reactivated at the end of the specified period.

                          </li>
                          <li>
                            In case you have permanently deleted or deactivated your account, this action is permanent.
              ...
              <div id='viewall' className="mt-3 hide-section">
                <div className="accordion mb-5" id="accordionExample">
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={btnClick4} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse12" aria-expanded="false" aria-controls="collapse12">
                        <span> <img src="images/faq/faq-kyc.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={myaccountbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse13" aria-expanded="false" aria-controls="collapse13">
                        <span><img src="images/faq/faq-Account.svg"
                        />&nbsp;&nbsp; My Account </span>
                      </button>
                    </h2>
                  </div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={depositbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-deposit.svg"
                        />&nbsp;&nbsp; Deposit </span>
                      </button>
                    </h2>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={withdrawalbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-withdrawal.svg"
                        />&nbsp;&nbsp; Withdrawal </span>
                      </button>
                    </h2>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={tdsbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-tax.svg"
                        />&nbsp;&nbsp; TDS </span>
                      </button>
                    </h2>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={promotionsbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-promotions.svg"
                        />&nbsp;&nbsp; Promotions </span>
                      </button>
                    </h2>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={invitebtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-refer.svg"
                        />&nbsp;&nbsp; Invite & Earn </span>
                      </button>
                    </h2>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={refundsbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-winnings.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={unfairbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-unfair.svg"
                        />&nbsp;&nbsp; Unfair Gameplay
                        </span>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={responsiblebtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-responsible.svg"
                        />&nbsp;&nbsp; Responsible Gaming
                        </span>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={gameplaybtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-technical.svg"
                        />&nbsp;&nbsp; Gameplay Technical
                        </span>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={registrationbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-signup.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={eventsbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-events.svg"
                        />&nbsp;&nbsp; Events </span>
                      </button>
                    </h2>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={navigationbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-game.svg"
                        />&nbsp;&nbsp; Gameplay Navigation
                        </span>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={tutorialbtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-tutorial.svg"
                        />&nbsp;&nbsp; Gameplay Tutorial
                        </span>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" >
                      <button onClick={legalitybtn} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                        <span><img src="images/faq/faq-legal.svg"
                        />&nbsp;&nbsp; Legality & Compliance
                        </span>
                      </button>
                    </h2>
                ...
                <div className="accordion" id="accordionExample">
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading13">
                      ...
                      <span>I want to update my KYC in my PokerBaazi <br /> account. How do I do
                        that?</span>
                      </button>
                    </h2>
                    <div id="collapse13" className="accordion-collapse collapse" aria-labelledby="heading13" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <p>Follow the steps to update your KYC.
                      </p>
                      <ol>
                        <li>Login to your PokerBaazi account through PokerBaazi.com or your mobile application.</li>
                        <li>In the mobile application, tap on your avatar and click on My Profile, on the following page
                          upload your address proof, PAN card number, and bank details.</li>
                        <li>On the web browser, click on My dashboard and then ‘KYC’ on the following page. Upload your
                          address proof, enter your PAN card number and update your bank details.</li>
                        <li>Save the details and wait for the KYC to be approved.</li>
                      </ol>
                      <p>
                        NOTE: While uploading KYC, please ensure that the image format should be JPG, PNG & JPEG, the
                        file size should be less than 5 MB and the image should be clear and readable.
                        We accept the bank details of most of the banks. However, the withdrawal is not possible in:

                      </p>
                      <ul>
                        <li>Minor bank account</li>
                        <li>Joint bank account</li>
                        <li>Company’s bank account</li>
                        <li>Post Office account</li>
                        <li>Any international bank account</li>
                      </ul>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading14">
                      ...
                      <span>What if I am unable to upload KYC documents?</span>
                      </button>
                    </h2>
                    <div id="collapse14" className="accordion-collapse collapse" aria-labelledby="heading14" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <p>
                        There could be any of the following reasons for that:
                      </p>
                      <ol>
                        <li>If you are trying to enter an incorrect ID number.</li>
                        <li>If you are trying to upload an image that is more than 5 MB.</li>
                        <li>If you are trying to upload an image that is not JPEG, JPG, or PNG.</li>
                        <li>If you are trying to upload any random Image in the KYC section.</li>
                        <li>If you are trying to upload an unreadable image of your address proof.</li>
                        <li>If there is an Internet Fluctuation while uploading documents.</li>
                        <li>We also recommend you to clear cache and cookies from the browser and cache from the
                          application and then re-login.</li>
                      </ol>
                      <p>
                        <strong>NOTE:</strong> In case all the above points are checked and ensured. If the issue still
                        persists, we request you to share the screenshot/video. We will immediately get it checked with
                        the technical team.
                      </p>
                      </div>
                    </div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading15">
                      ...
                      <span><span>My KYC status is pending/rejected. What to do now?</span></span>
                      </button>
                    </h2>
                    <div id="collapse15" className="accordion-collapse collapse" aria-labelledby="heading15" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <p>
                        Pending: Not to worry, if it is pending, it means we are reviewing the details. You can still
                        continue playing and deposit/withdraw money from your account. For any further assistance on
                        this, you can write to us at <a>playerrelations@pokerbaazi.com</a> or Chat with us.
                      </p>
                      <p>
                        Rejected: Please be informed that your KYC might be rejected due to any of the following
                        reasons. If it is not due to any of these, please write to us at
                        <a>playerrelations@pokerbaazi.com</a> or chat with us.
                      </p>
                      <ul>
                        <li>Document Image not clear</li>
                        <li>Uploaded any random Image</li>
                        <li>Uploaded KYC is of under 18 age</li>
                        <li>NRI KYC</li>
                        <li>International KYC</li>
                        <li>Mismatch in KYC and Bank details</li>
                        <li>Minor PAN card</li>
                        <li>Restricted State KYC</li>
                      </ul>                     
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading16">
                      ...
                      <span>Can I change my bank details?</span>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading17">
                      ...
                      <span>How can I verify my email address?</span>
                      </button>
                    </h2>
                    <div id="collapse17" className="accordion-collapse collapse" aria-labelledby="heading17" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <p>
                        Please follow the steps to verify your email address:
                      </p>
                      <ol>
                        <li>Login to your PokerBaazi account through a web browser and mobile application.</li>
                        <li>On the web browser click on “Verify Account” and enter your email address..</li>
                        <li>In the mobile application, tap on the avatar followed by ‘My Profile’, add your email in the
                          email box and tap on verify.</li>
                        <li>Enter the OTP tab to receive OTP on your registered email address to verify your email
                          address.</li>
                      </ol>
                      <p>Please note that you may change your email address before verifying the email address which you
                        updated at the time of registration.</p>                   
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading18">
                      ...
                      <span>What are the mandate KYC's in
                      PokerBaazi?</span>
                      </button>
                    </h2>
                    <div id="collapse18" className="accordion-collapse collapse" aria-labelledby="heading18" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <p>
                        Aadhar Card (front & backside), Pan Card (Number), and bank details are the three mandatory
                        documents required for KYC.
                      </p>
                      <p>
                        In case you don’t have an Aadhar card as an address proof, kindly submit the soft copy of any
                        one of the following documents:
                      </p>
                      <ul>
                        <li>Driving License - Front Copy</li>
                        <li>Voter ID - Front and back copy</li>
                      </ul>
                      <p><b>NOTE:</b> Ensure all the documents should be under the same name only.</p>                  
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading19">
                      ...
                      <span>How can I compress my Docs to 5 MB?</span>
                      </button>
                    </h2>
                    <div id="collapse19" className="accordion-collapse collapse" aria-labelledby="heading19" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <p>You can use any third-party website to compress the file under 5MB.
                        Eg: http://compressimage.toolur.com</p>                   
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="heading20">
                      ...
                      <span>I want to change my KYC documents in my PokerBaazi account as the
                        wrong documents were uploaded/my details are mismatched in the account. What should I
                        do?</span>
                      </button>
                    </h2>
                    <div id="collapse20" className="accordion-collapse collapse" aria-labelledby="heading20" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                      <ol>
                        <li>Please be informed that KYC/Bank details once updated cannot be changed.</li>
                        <li>In case there is a mismatch, please drop your KYC documents along with the bank
                          statement/passbook/cheque at <a>playerrelations@pokerbaazi.com</a> or chat with us. Our team
                          will review and get back to you with the resolution.</li>
                      </ol>                     
                      </div>
                    </div>
                  </div>
