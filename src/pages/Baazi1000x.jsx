    ...
    <div>
      ...
      <div className=" tab-content pt-0 mt-0 pb-5 mb-5" id="pills-tabContent">
        ...
        <div className='text-center'>
          <div>
            <img src='./images/1000x/maincard.png' alt='img1' className='img-fluid' />
          </div>
           <h3 className='text-center pt-4'>Series Highlights</h3>
          <div className='p-3'>
            <img src='../images/1000x/Card2.png' alt='img2' className='img-fluid' />
          </div>

          <div className='px-3'>
            <img src='../images/1000x/Card3.png' alt='img3' className='img-fluid' />
          </div>

          <div className='p-3'>
            <img src='../images/1000x/Card4.png' alt='img4' className='img-fluid' />
          </div>

          <div className='px-3'>
            <img src='../images/1000x/Card5.png' alt='img5' className='img-fluid' />
          </div>
        </div>
          </div>
