...
import schedule from '../json/cash-royal/holdem/schedule.json'
// import scheduleFinal from '../json/cash-royal/holdem/scheduleFinal.json'
import Topheader from '../components/Topheader';

export default function CashRoyal5() {
  return (
    <div>
      <Topheader colorbox="black-box" title="Cash Royal 5.0" />
      <div className="container tab-content pb-5 mb-5" id="pills-tabContent">
          ...
          <div className='pt-2'>
            <div className="container mt-3">
              ...
              <ul className="nav nav-tabs" role="tablist">
                ...
                <li className="nav-item">
                  <a className="nav-link" data-bs-toggle="tab" href="#menu1">Micro</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-bs-toggle="tab" href="#menu2">Low</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-bs-toggle="tab" href="#menu2">Mid</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-bs-toggle="tab" href="#menu2">High</a>
                </li>
              </ul>
                ...
                <div id="home" className=" tab-pane active"><br />
                  {
                    schedule.map(schedule => {
                      return (
                        <div>
                          {(typeof schedule.Break !== 'undefined' && schedule.Break === true) &&
                            <div className='pb-3'>
                              <img src="images/icons/stakes-icon.svg" alt="" /><strong> Stakes:{schedule.Stakes}</strong>
                            </div>
                          }
                          <div className='schedule-box'>
                            <span className="bluebox-txt">HOLD’EM</span>
                            <div><p className='p-3 m-0'>{schedule.Time}</p></div>
                            <div className="d-flex justify-content-between mb-4 blue-shade px-3 py-2">
                              <div className='yellow-color'> <img src="images/icons/award-trophy.png" width={22} alt="" /> ₹{schedule.PrizePool}</div>
                              <div>Places Paid- <strong>{schedule['Places Paid']}</strong></div>
                            </div>
                          </div>
                        </div>
                      )
                        ...
                        <div>
                          {
                            ...
                            (typeof schedule.Break !== 'undefined' && schedule.Break === true && schedule.Type == "micro") &&
                            <div>
                              <div className='pb-3'>
                                <img src="images/icons/stakes-icon.svg" alt="" /><strong> Stakes:{schedule.Stakes}</strong>
                              </div>
