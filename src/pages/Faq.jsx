...
export default function Faq() {
  ...
  function myFunction() {
    var input, filter, i,div,h2,button;
    input = document.getElementById("mySearch");
    filter = input.value.toUpperCase();
    div = document.getElementById("helpdesk")
    ...
    for (i = 0; i < h2.length; i++) {
      ...
      if (button.innerHTML.toUpperCase().indexOf(filter) > -1) {
        h2[i].style.display = "";
        document.getElementById("faqva").style.display = "block";
        document.getElementById("faqmi").style.display = "block";
        document.getElementById("accountandkyc").style.display = "block";
        
      } else {
        h2[i].style.display = "none";
        document.getElementById("faqva").style.display = "none";
        document.getElementById("faqmi").style.display = "none";
        document.getElementById("accountandkyc").style.display = "none";
      }
    }
  }
  return (
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className='pt-3 text-center'>
                  <form>
                    <input className='search-box-cus' type="text" id="mySearch" placeholder="Search Your issue here..." name="search" />
                    <button className='search-box-button' type="button" onClick={myFunction}>Search</button>
                  </form>              
                </div>
                <div id='faqva'>
